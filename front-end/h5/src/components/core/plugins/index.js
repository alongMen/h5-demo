...
import LbpCascader from 'core/plugins/lbp-cascader'
...
import lbpCalendarBar from 'core/plugins/lbp-calendar-bar'
...
export const pluginsList = [
  ...
  },
  {
    ...
    icon: 'volume-up',
    component: lbpCalendarBar,
    visible: true,
    name: lbpCalendarBar.name
  },
  ...
  },
  {
    ...
    title: '地址选择',
    icon: 'dot-circle-o',
    component: LbpCascader,
    visible: true,
    name: LbpCascader.name
  },
  {
    i18nTitle: {
      'en-US': 'Background',
